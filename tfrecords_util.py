...
if __name__ == '__main__':
    ...
    rgvs = sys.argv
    if(argc != 7):
        print 'Usage: python %s examples_list_file name output_directory resize resize_height resize_width' % argvs[0]
        quit()
    examples_list_file = argvs[1]
    name = argvs[2]
    output_directory = argvs[3]
    resize = argvs[4]
    resize_height = argvs[5]
    resize_width = argvs[6]
    transform2tfrecord(examples_list_file, name, output_directory, resize, resize_height, resize_width)
